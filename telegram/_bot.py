...
class Bot(TelegramObject, contextlib.AbstractAsyncContextManager["Bot"]):
    ...
    Args:
        ...
        base_url (:obj:`str` | Callable[[:obj:`str`], :obj:`str`], optional): Telegram Bot API
            ...
            string. Defaults to ``"https://tapi.bale.ai/bot"``.
            ...
            Tip:
                ...
                Example:
                    ``"https://tapi.bale.ai/bot{token}/test"``
        ...
        base_file_url (:obj:`str`, optional): Telegram Bot API file URL.
            ...
            Tip:
                ...
                Example:
                    ``"https://tapi.bale.ai/file/bot{token}/test"``
    ...
    def __init__(
        self,
        token: str,
        base_url: BaseUrl = "https://tapi.bale.ai/bot",
        base_file_url: BaseUrl = "https://tapi.bale.ai/file/bot",
        ...
        if (
            ...
            and not self.base_url.startswith("https://tapi.bale.ai/bot")
        ):
