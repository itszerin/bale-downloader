...
class ApplicationBuilder(Generic[BT, CCT, UD, CD, BD, JQ]):
    ...
    def __init__(self: "InitApplicationBuilder"):
        ...
        self._base_url: DVType[BaseUrl] = DefaultValue("https://tapi.bale.ai/bot")
        self._base_file_url: DVType[BaseUrl] = DefaultValue("https://tapi.bale.ai/file/bot")
    ...
    def base_url(self: BuilderType, base_url: BaseUrl) -> BuilderType:
        ...
        will default to ``'https://tapi.bale.ai/bot'``.
    ...
    def base_file_url(self: BuilderType, base_file_url: BaseUrl) -> BuilderType:
        ...
        called, will default to ``'https://tapi.bale.ai/file/bot'``.
